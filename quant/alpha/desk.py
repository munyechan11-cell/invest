...
class TradingDesk(AlphaModel):
    ...
    def __init__(
        ...
        *,
        ...
        #:
        #: 한도가 빠듯한 키(무료 티어)에서는 낮춰야 합니다 — 같은 순간에
        #: 좌석 수 × 종목 수만큼 호출이 나가고, 튕긴 호출은 백오프만큼
        #: 기다렸다 다시 나가므로 넓게 보려다 느려집니다.
        #:
        #: 기본값을 2 로 뒀던 때가 있는데, 그 근거("429 재시도가 1,064번")는
        #: **집계 오류** 였습니다 — 정규식이 한투 URL 의 `/quotations/` 안에

...
적혀 있습니다. 실거래 사이징은 설정의 `starting_cash` 가 아니라 **증권사가
말하는 실제 평가액** 을 읽으므로, 그 둘이 어긋나면 계좌가 조금만 커져도 모든
진입이 거절되고 조금만 작아도 아무것도 사지 않습니다. 둘 다 예외가 아니라
침묵이라, 화면은 "대기 중" 만 보여 줍니다.
"""
